...
${OBJECTDIR}/src/MSG/Dequeueer.o: src/MSG/Dequeueer.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../libtools/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MSG/Dequeueer.o src/MSG/Dequeueer.cpp

${OBJECTDIR}/src/MSG/Filter.o: src/MSG/Filter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/MSG
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../libtools/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MSG/Filter.o src/MSG/Filter.cpp

${OBJECTDIR}/src/MSG/Message.o: src/MSG/Message.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/MSG
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../libtools/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MSG/Message.o src/MSG/Message.cpp

${OBJECTDIR}/src/MSG/Messenger.o: src/MSG/Messenger.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/MSG
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../libtools/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MSG/Messenger.o src/MSG/Messenger.cpp
